...
const hallmarks = [
  'genomic_instability', 'telomere_attrition', 'epigenetic_alterations', 'loss_of_proteostasis',
  'disabled_macroautophagy', 'deregulated_nutrient_sensing', 'mitochondrial_dysfunction',
...
const maturityLadder = [
  'social_anecdotal', 'mechanistic_hypothesis', 'in_vitro_ex_vivo', 'animal_model',
  'human_observational', 'early_human_interventional', 'controlled_clinical_trial',
  'replicated_controlled_or_synthesis', 'regulatory_or_guideline_supported',
];

const maturityX = {
  social_anecdotal: 0.05, mechanistic_hypothesis: 0.15, in_vitro_ex_vivo: 0.25, animal_model: 0.35,
  human_observational: 0.5, early_human_interventional: 0.65, controlled_clinical_trial: 0.8,
  replicated_controlled_or_synthesis: 0.9, regulatory_or_guideline_supported: 0.98,
};
...
function assessment(id, subjectId, subjectType, maturity, attention, extras = {}) {
  return {
    ...
    attentionRationale: extras.attentionRationale ?? ['Demo attention derived from seeded mention velocity.'],
...
const interventions = [
  {
    ...
    biologicalTargets: ['AMPK', 'hepatic gluconeogenesis'], ageingHallmarks: ['deregulated_nutrient_sensing', 'mitochondrial_dysfunction'],
    wadaStatus: 'not_listed', relatedPaperIds: ['paper-metformin-rct', 'paper-metformin-obs'], relatedTrialIds: ['trial-metformin-tame-demo'],
    isPeptide: false, unapprovedWarning: false,
    provenance: { sourceIds: ['src-demo-manual'], sourceRecordIds: ['srec-1'], notes: 'Demo intervention dossier.' },
  },
  {
    ...
    biologicalTargets: ['mTORC1'], ageingHallmarks: ['deregulated_nutrient_sensing', 'disabled_macroautophagy', 'cellular_senescence'],
    wadaStatus: 'not_listed', relatedPaperIds: ['paper-rapamycin-animal', 'paper-rapamycin-early'], relatedTrialIds: ['trial-rapamycin-early'],
    isPeptide: false, unapprovedWarning: false,
  ...
  },
  {
    ...
    biologicalTargets: ['skeletal muscle', 'VO2 pathways'], ageingHallmarks: ['stem_cell_exhaustion', 'mitochondrial_dysfunction', 'chronic_inflammation'],
    wadaStatus: 'not_listed', relatedPaperIds: ['paper-exercise-synthesis'], relatedTrialIds: ['trial-exercise-au'],
    isPeptide: false, unapprovedWarning: false,
    provenance: { sourceIds: ['src-demo-manual'], sourceRecordIds: ['srec-1'] },
  },
  {
    ...
    biologicalTargets: ['NAD+ biosynthesis'], ageingHallmarks: ['mitochondrial_dysfunction', 'deregulated_nutrient_sensing'],
    wadaStatus: 'unknown', relatedPaperIds: ['paper-nmn-early', 'paper-nmn-invitro'], relatedTrialIds: ['trial-nmn-recruiting'],
    isPeptide: false, unapprovedWarning: false,
    provenance: { sourceIds: ['src-demo-manual'], sourceRecordIds: ['srec-1'] },
  },
  {
    ...
    demonstratedIndications: [],
    biologicalTargets: ['senescent cell anti-apoptotic pathways'], ageingHallmarks: ['cellular_senescence'],
    wadaStatus: 'unknown', relatedPaperIds: ['paper-senolytic-animal'], relatedTrialIds: ['trial-senolytic-withdrawn'],
    isPeptide: false, unapprovedWarning: true,
    provenance: { sourceIds: ['src-demo-manual'], sourceRecordIds: ['srec-1'] },
  },
];
...
for (let i = 1; i <= 7; i++) {
  ...
  interventions.push({
    ...
    wadaStatus: 'unknown', relatedPaperIds: [], relatedTrialIds: [], isPeptide: false, unapprovedWarning: false,
    provenance: { sourceIds: ['src-demo-manual'], sourceRecordIds: ['srec-1'] },
  });
}
...
const peptides = [
  {
    ...
    ageingHallmarks: ['altered_intercellular_communication'], wadaStatus: 'prohibited',
    relatedPaperIds: ['paper-bpc-animal'], relatedTrialIds: ['trial-bpc-early'],
    isPeptide: true, unapprovedWarning: true, sequenceHint: 'Demo sequence withheld',
    provenance: { sourceIds: ['src-demo-manual'], sourceRecordIds: ['srec-1'], notes: 'Unapproved peptide — informational only.' },
  },
  {
    ...
    wadaStatus: 'unknown', relatedPaperIds: ['paper-epitalon-invitro'], relatedTrialIds: [],
    isPeptide: true, unapprovedWarning: true,
    provenance: { sourceIds: ['src-demo-manual'], sourceRecordIds: ['srec-1'] },
  },
];
...
const papers = [
  {
    ...
    ageingHallmarks: ['deregulated_nutrient_sensing'], provenance: { sourceIds: ['src-demo-manual'], sourceRecordIds: ['srec-1'] },
  },
  {
  ...
  },
  {
    ...
    relatedInterventionIds: ['int-nmn'], ageingHallmarks: ['mitochondrial_dysfunction'],
    provenance: { sourceIds: ['src-demo-manual', 'src-crossref-stub'], sourceRecordIds: ['srec-1', 'srec-5'] },
  },
  {
...
const trials = [
  {
    ...
    phase: 'Phase 3 (demo)', design: 'Randomised, parallel, placebo-controlled',
    conditions: ['Ageing-related multimorbidity (demo)'], interventions: ['Metformin'], relatedInterventionIds: ['int-metformin'],
    locations: [{ country: 'United States', city: 'Demo City' }, { country: 'Australia', city: 'Melbourne', australiaRelevant: true }],
    healthyVolunteers: false, ageRange: '65-79', sponsor: 'Demo Longevity Consortium',
    primaryOutcomes: ['Time to new age-related disease (demo endpoint)'], enrollmentTarget: 3000, enrollmentActual: null,
    resultsPosted: false, provenance: { sourceIds: ['src-demo-manual', 'src-ctg-stub'], sourceRecordIds: ['srec-1', 'srec-3'] },
  },
  {
    ...
    phase: 'Phase 1/2 (demo)', design: 'Open-label', conditions: ['Healthy ageing volunteers (demo)'],
    interventions: ['Rapamycin'], relatedInterventionIds: ['int-rapamycin'],
    locations: [{ country: 'United States', city: 'Boston' }], healthyVolunteers: true, ageRange: '50-75',
    sponsor: 'Demo Translational Institute', primaryOutcomes: ['Safety', 'Selected ageing biomarkers'],
    enrollmentTarget: 40, enrollmentActual: 38, resultsPosted: false,
    provenance: { sourceIds: ['src-demo-manual'], sourceRecordIds: ['srec-1'] },
  },
  {
    ...
    phase: 'Phase 2 (demo)', design: 'RCT', conditions: ['Impaired glucose tolerance (demo)'], interventions: ['NMN'],
    relatedInterventionIds: ['int-nmn'], locations: [{ country: 'Australia', city: 'Sydney', australiaRelevant: true }],
    healthyVolunteers: false, ageRange: '40-70', sponsor: 'Demo Metabolic Lab AU',
    primaryOutcomes: ['HOMA-IR change'], enrollmentTarget: 120, enrollmentActual: 18, resultsPosted: false,
    provenance: { sourceIds: ['src-demo-manual', 'src-anzctr-stub'], sourceRecordIds: ['srec-1', 'srec-6'] },
  },
  {
    ...
    statusHistory: [
      ...
      { status: 'withdrawn', at: iso('2025-02-01'), note: 'Sponsor decision / safety monitoring (demo)' },
    ],
    phase: 'Phase 2 (demo)', design: 'RCT', conditions: ['Frailty (demo)'], interventions: ['Demo-Senol-X'],
    relatedInterventionIds: ['int-senolytic-demo'], locations: [{ country: 'United Kingdom', city: 'London' }],
    healthyVolunteers: false, ageRange: '70+', sponsor: 'Demo Biotech', primaryOutcomes: ['Frailty index'],
    enrollmentTarget: 80, enrollmentActual: 0, resultsPosted: false,
    provenance: { sourceIds: ['src-demo-manual'], sourceRecordIds: ['srec-1'] },
  },
  {
    ...
    phase: 'N/A (behavioural)', design: 'RCT', conditions: ['Community-dwelling older adults'],
    interventions: ['Structured exercise'], relatedInterventionIds: ['int-exercise'],
    locations: [
      { country: 'Australia', city: 'Brisbane', australiaRelevant: true },
      { country: 'Australia', city: 'Adelaide', australiaRelevant: true },
    ],
    healthyVolunteers: true, ageRange: '65-85', sponsor: 'Demo AU University',
    primaryOutcomes: ['Short Physical Performance Battery'], enrollmentTarget: 200, enrollmentActual: 188, resultsPosted: true,
    provenance: { sourceIds: ['src-demo-manual', 'src-anzctr-stub'], sourceRecordIds: ['srec-1', 'srec-6'] },
  },
  {
    ...
    statusHistory: [
      ...
      { status: 'terminated', at: iso('2023-09-01'), note: 'Terminated for enrollment futility (demo)' },
    ],
    phase: 'Phase 1 (demo)', design: 'Open-label', conditions: ['Healthy volunteers'], interventions: ['BPC-157'],
    relatedInterventionIds: ['pep-bpc157'], locations: [{ country: 'Canada', city: 'Toronto' }],
    healthyVolunteers: true, ageRange: '18-45', sponsor: 'Demo Peptide Co',
    primaryOutcomes: ['Adverse events'], enrollmentTarget: 24, enrollmentActual: 7, resultsPosted: false,
    provenance: { sourceIds: ['src-demo-manual'], sourceRecordIds: ['srec-1'] },
  },
];
...
for (let i = 1; i <= 6; i++) {
  ...
  trials.push({
    ...
    phase: `Phase ${(i % 3) + 1}`, design: 'RCT', conditions: ['Demo condition'], interventions: ['Demo agent'],
    relatedInterventionIds: [interventions[i % interventions.length].id],
    locations: i % 2 ? [{ country: 'Australia', city: 'Perth', australiaRelevant: true }] : [{ country: 'Germany', city: 'Berlin' }],
    healthyVolunteers: i % 2 === 0, ageRange: '18-80', sponsor: 'Demo Sponsor',
    primaryOutcomes: ['Demo endpoint'], enrollmentTarget: 50 + i * 10, enrollmentActual: i * 5,
    resultsPosted: i % 3 === 0, provenance: { sourceIds: ['src-demo-manual'], sourceRecordIds: ['srec-1'] },
  });
}
...
function pushA(a) { assessments.push(a); }

pushA(assessment('ea-int-metformin', 'int-metformin', 'intervention', 'regulatory_or_guideline_supported', 0.55, {
  studyDesign: 'randomised_controlled', peerReviewStatus: 'peer_reviewed', confidenceScore: 0.82,
  confidenceRationale: ['Approved indication with large human exposure for diabetes.', 'Longevity indication remains unproven; separate from approved use.'],
  translationGaps: ['disease_treatment_to_longevity'],
  regulatoryStatuses: [{ jurisdiction: 'AU', status: 'approved', indication: 'Type 2 diabetes' }, { jurisdiction: 'US', status: 'approved', indication: 'Type 2 diabetes' }, { jurisdiction: 'AU', status: 'off_label', indication: 'Longevity (not established)' }],
  safetyNotes: ['GI adverse effects common; lactic acidosis rare but serious in susceptible patients.'],
  whatWouldChangeAssessment: ['Completed large RCT with hard ageing outcomes (demo TAME-like).'],
}));

pushA(assessment('ea-int-rapamycin', 'int-rapamycin', 'intervention', 'early_human_interventional', 0.7, {
  studyDesign: 'non_randomised_interventional', confidenceScore: 0.58,
  translationGaps: ['animal_to_human', 'biomarker_to_health_outcome'],
  regulatoryStatuses: [{ jurisdiction: 'US', status: 'approved', indication: 'Transplant (context)' }, { jurisdiction: 'AU', status: 'approved', indication: 'Specific approved contexts' }, { jurisdiction: 'global', status: 'off_label', indication: 'Longevity dosing' }],
  safetyNotes: ['Immunosuppression and metabolic adverse effects require clinical oversight.'],
}));

pushA(assessment('ea-int-exercise', 'int-exercise', 'intervention', 'replicated_controlled_or_synthesis', 0.25, {
  studyDesign: 'systematic_review_meta_analysis', confidenceScore: 0.9,
  confidenceRationale: ['Multiple RCTs and syntheses support functional outcomes.', 'Low social-feed attention relative to evidence strength in this demo.'],
  attentionRationale: ['Demo attention score kept low to illustrate undernoticed strong evidence.'],
  regulatoryStatuses: [{ jurisdiction: 'global', status: 'unknown' }],
  translationGaps: [],
}));

pushA(assessment('ea-int-nmn', 'int-nmn', 'intervention', 'early_human_interventional', 0.85, {
  confidenceScore: 0.45, translationGaps: ['biomarker_to_health_outcome', 'short_term_to_durable'],
  regulatoryStatuses: [{ jurisdiction: 'AU', status: 'unknown' }, { jurisdiction: 'US', status: 'unapproved' }],
  safetyNotes: ['Product quality variability; see demo TGA recall narrative.'],
}));

pushA(assessment('ea-int-senolytic', 'int-senolytic-demo', 'intervention', 'animal_model', 0.92, {
  confidenceScore: 0.3, translationGaps: ['animal_to_human'],
...
pushA(assessment('ea-pep-bpc157', 'pep-bpc157', 'peptide', 'animal_model', 0.88, {
  confidenceScore: 0.25, translationGaps: ['animal_to_human'],
  regulatoryStatuses: [{ jurisdiction: 'AU', status: 'unapproved' }, { jurisdiction: 'US', status: 'unapproved' }, { jurisdiction: 'global', status: 'prohibited' }],
  safetyNotes: ['Unapproved peptide; compounding quality and sterility uncertainty.', 'WADA prohibited status relevant for athletes.'],
}));

pushA(assessment('ea-pep-epitalon', 'pep-epitalon', 'peptide', 'in_vitro_ex_vivo', 0.6, {
  confidenceScore: 0.2, translationGaps: ['cell_to_organism', 'animal_to_human'],
  regulatoryStatuses: [{ jurisdiction: 'global', status: 'unknown' }],
  safetyNotes: ['Unapproved peptide demonstration example.'],
}));

for (const p of peptides.filter((x) => x.id.startsWith('pep-gen-'))) {
  pushA(assessment(`ea-${p.id}`, p.id, 'peptide', 'mechanistic_hypothesis', 0.4 + Math.random() * 0.2, {
    confidenceScore: 0.2, regulatoryStatuses: [{ jurisdiction: 'global', status: 'unapproved' }],
    safetyNotes: ['Unapproved demo peptide.'], translationGaps: ['cell_to_organism'],
  }));
}
for (const it of interventions.filter((x) => x.id.startsWith('int-gen-'))) {
  pushA(assessment(`ea-${it.id}`, it.id, 'intervention', maturityLadder[it.id.length % maturityLadder.length], 0.3, {
    confidenceScore: 0.4, regulatoryStatuses: [{ jurisdiction: 'global', status: 'unknown' }],
  }));
}
...
for (const paper of papers) {
  ...
  pushA(assessment(paper.assessmentId, paper.id, 'paper', maturity, attention, {
    studyDesign: paper.studyDesign,
    peerReviewStatus: paper.peerReviewStatus,
    confidenceScore: confidence,
    translationGaps: paper.speciesOrPopulation.includes('Mice') || paper.speciesOrPopulation.includes('Rats')
      ? ['animal_to_human']
      : paper.studyDesign === 'in_vitro'
        ...
        : paper.studyDesign === 'cohort'
          ...
          : [],
    safetyNotes: paper.isCorrectionOrRetraction ? ['Retracted or corrected — do not use as current evidence.'] : [],
  }));
}

for (const trial of trials) {
  const maturity = trial.resultsPosted ? 'controlled_clinical_trial' : 'early_human_interventional';
  pushA(assessment(trial.assessmentId, trial.id, 'trial', maturity, trial.status === 'recruiting' ? 0.65 : 0.4, {
    confidenceScore: trial.status === 'withdrawn' || trial.status === 'terminated' ? 0.25 : 0.5,
    safetyNotes: trial.status === 'withdrawn' || trial.status === 'terminated' ? ['Trial ended early — interpret cautiously.'] : [],
    regulatoryStatuses: [{ jurisdiction: 'global', status: 'investigational' }],
  }));
}

for (const c of creators) {
  pushA(assessment(c.assessmentId, c.id, 'creator', 'social_anecdotal', c.id.includes('hype') ? 0.9 : 0.4, {
    confidenceScore: 0.35, attentionRationale: ['Creator attention is not scientific validation.'],
  }));
}
for (const c of claims) {
  pushA(assessment(c.assessmentId, c.id, 'claim', c.id.includes('exercise') ? 'replicated_controlled_or_synthesis' : 'social_anecdotal', c.id.includes('overclaim') ? 0.9 : 0.4, {
    confidenceScore: 0.3,
  }));
}
for (const r of regulatoryEvents) {
  pushA(assessment(r.assessmentId, r.id, 'regulatory_event', 'regulatory_or_guideline_supported', 0.5, {
    confidenceScore: 0.7, safetyNotes: [r.summary],
    regulatoryStatuses: [{ jurisdiction: r.jurisdiction, status: r.severity === 'critical' || r.severity === 'high' ? 'unapproved' : 'unknown' }],
  }));
}
...
for (const { item, shape } of radarSubjects) {
  ...
  radar.push({
    ...
    safetyConcern: ea.safetyNotes.length > 0 || ea.regulatoryStatuses.some((s) => s.status === 'unapproved' || s.status === 'prohibited'),
    shape,
  });
}
...
const totalRecords =
  papers.length + trials.length + interventions.length + peptides.length + creators.length +
  claims.length + regulatoryEvents.length + organisations.length + watchlists.length +
  changeEvents.length + reviewTasks.length;
