...
export const seedBundle = {
  ...
  },
  {
    ...
    "safetyNotes": [
      "Immunosuppression and metabolic adverse effects require clinical oversight."
    ],
    "regulatoryStatuses": [
      {
        "jurisdiction": "US",
  ...
  },
  {
    ...
    "safetyNotes": [
      "Product quality variability; see demo TGA recall narrative."
    ],
    "regulatoryStatuses": [
      {
        "jurisdiction": "AU",
  ...
  },
  {
    ...
    "attentionScore": 0.92,
    "attentionRationale": [
      "Viral creator coverage drives attention far above evidence maturity."
    ],
    "safetyNotes": [
      "Withdrawn demo trial; human safety unsettled."
    ],
    "regulatoryStatuses": [
      {
        "jurisdiction": "global",
  ...
  },
  {
    ...
    "safetyNotes": [
      "Unapproved peptide demonstration example."
    ],
    "regulatoryStatuses": [
      {
        "jurisdiction": "global",
  ...
  },
  {
    ...
    "attentionScore": 0.4,
    "attentionRationale": [
      "Creator attention is not scientific validation."
    ],
    "safetyNotes": [],
    "regulatoryStatuses": [],
    "whatWouldChangeAssessment": [
  ...
  },
  {
    ...
    "safetyNotes": [
      "Fictional ARTG-adjacent recall narrative for product-quality uncertainty."
    ],
    "regulatoryStatuses": [
      {
        "jurisdiction": "AU",
  ...
  },
  {
    ...
    "safetyNotes": [
      "US label-change demo tied to rapamycin dossier."
    ],
    "regulatoryStatuses": [
      {
        "jurisdiction": "US",
  ...
  },
  {
    ...
    "safetyNotes": [
      "Sport/WADA prohibited status callout for peptide dossier."
    ],
    "regulatoryStatuses": [
      {
        "jurisdiction": "global",
  ...
  trials: [
  {
    ...
    "conditions": [
      "Ageing-related multimorbidity (demo)"
    ],
    "interventions": [
      "Metformin"
    ],
    ...
    "primaryOutcomes": [
      "Time to new age-related disease (demo endpoint)"
    ],
  ...
  },
  {
    ...
    "design": "Open-label",
    "conditions": [
      "Healthy ageing volunteers (demo)"
    ],
    "interventions": [
      "Rapamycin"
    ],
  ...
  },
  {
    ...
    "design": "RCT",
    "conditions": [
      "Impaired glucose tolerance (demo)"
    ],
    "interventions": [
      "NMN"
    ],
  ...
  interventions: [
  {
    ...
    "type": "intervention",
    "title": "Metformin",
    "summary": "Biguanide with established diabetes indication and ongoing longevity-adjacent research interest.",
    "tags": [
      "metabolic",
      "approved-drug"
    ],
  ...
  },
  {
    ...
    "demonstratedIndications": [
      "Organ transplant rejection prophylaxis (approved contexts)"
    ],
    "biologicalTargets": [
      "mTORC1"
    ],
    ...
    "wadaStatus": "not_listed",
    "relatedPaperIds": [
      "paper-rapamycin-animal",
      "paper-rapamycin-early"
    ],
    "relatedTrialIds": [
      "trial-rapamycin-early"
    ],
    "isPeptide": false,
    "unapprovedWarning": false,
    "provenance": {
  ...
  },
  {
    ...
    "summary": "High-evidence lifestyle intervention for function, cardiometabolic health, and healthspan.",
    "tags": [
      "lifestyle",
      "high-evidence"
    ],
  ...
  },
  {
    ...
    "summary": "Fictional senolytic combination used to illustrate weak-evidence / high-attention quadrant.",
    "tags": [
      "senolytic",
      "high-attention"
    ],
  ...
  peptides: [
  {
    ...
    "type": "peptide",
    "title": "BPC-157 (demo)",
    "summary": "Investigational/unapproved peptide example with strong online claims and weak controlled human evidence in this demo snapshot.",
    "tags": [
      "peptide",
      "unapproved"
    ],
    ...
    "demonstratedIndications": [],
    "biologicalTargets": [
      "angiogenesis-related pathways (hypothesized)"
    ],
    "ageingHallmarks": [
      "altered_intercellular_communication"
    ],
  ...
  },
  {
    ...
    "type": "peptide",
    "title": "Epitalon (demo)",
    "summary": "Fictionalised peptide dossier illustrating unknown regulatory status and telomere-related claims.",
    "tags": [
      "peptide",
      "telomere"
    ],
  ...
  creators: [
  {
    ...
    "sponsorshipDisclosures": [
      "Occasional book affiliate links disclosed"
    ],
    "relatedClaimIds": [
      "claim-exercise-undernoticed"
    ],
    "provenance": {
      "sourceIds": [
        "src-demo-manual"
  ...
  },
  {
    ...
    "sponsorshipDisclosures": [
      "Supplement brand sponsorships stated in descriptions"
    ],
    "relatedClaimIds": [
